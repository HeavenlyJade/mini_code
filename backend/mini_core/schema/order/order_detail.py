...
class OrderDetailCreateSchema(Schema):
    ...
    price = webargs_fields.Float(required=True, description='原价格')
    actual_price = webargs_fields.Float(required=True, description='实际购买价格')
    ...
    unit_price = webargs_fields.Float(description='商品单价')
    total_price = webargs_fields.Float(description='商品总价')
