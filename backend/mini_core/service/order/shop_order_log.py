...
from sqlalchemy import Column, String, Table, Integer, DateTime, Text, and_, or_, desc, BigInteger
...
order_log_table = Table(
    ...
    Column('old_value', Text, comment='修改前值'),
    Column('new_value', Text, comment='修改后值'),
